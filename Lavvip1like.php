...
$golike = get("https://dev.golike.net/api/advertising/publishers/tiktok/jobs?account_id=".$id."&data=null",$tsm1);/*[Tool Tao Cấm Buôn Bán ]*/
/*[Tools Nguyễn Văn Phúc ]*/
...
/*[Tools Nguyễn Văn Phúc ]*/
if($st=="0"){;sleep();continue;}else{echo " $ty | $uid          \r";}/*[Tool Tao Cấm Buôn Bán ]*/
/*[Tools Nguyễn Văn Phúc ]*/
("termux-open $link");/*[Tool Tao Cấm Buôn Bán ]*/
/*[Tools Nguyễn Văn Phúc ]*/
for($time=$delay;$time>-1;$time--){
;sleep();}/*[Tool Tao Cấm Buôn Bán ]*/
